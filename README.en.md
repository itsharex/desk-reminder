...
<p align="center">
  ...
  <a href="https://github.com/kaima2022/Health-reminder/releases"><img src="https://img.shields.io/badge/Version-1.6.2-orange?style=flat-square" alt="Version"></a>
</p>
...
- **Logo white border removed**: Cleaned up icon edges (including iOS AppIcon).
- **Idle banner shows time**: Idle banner now displays idle duration.
...
- **Lock Screen Optimization**: The lock screen now displays the names of all merged tasks, so you know exactly what the current break covers.
- **Logic Fixes**: Fixed issues where snooze and unlock actions during merged tasks did not correctly clear all related pending tasks.
