...
export default {
  ...
  app: {
    ...
    footer: 'Health Reminder v1.5.7 · Wishing you good health every day',
  ...
  settings: {
    ...
    currentVersion: 'Current version v1.5.7',
    newVersion: 'Current version v1.5.7 (New version v{version} available)',
    language: 'Language',
  },
